...
<el-form  :model="formModel"  :rules="rules"  ref="formModel" label-width="100px" >
    ...
    <el-row>
        <el-col :span="12">
            <el-form-item label="审核计算" prop="auditComputeType">
        ...
        <el-col :span="12">
            <el-form-item label="撤销计算" prop="unAuditComputeType">
    ...
    <el-row>
        <el-col :span="12">
            <el-form-item label="审核状态" prop="auditStateValue">
                <el-input-number v-model="formModel.auditStateValue"  :min="0" :max="100"></el-input-number>
            </el-form-item> 
        </el-col>
        <el-col :span="12">
            <el-form-item label="撤销状态" prop="unAuditStateValue">
                <el-input-number v-model="formModel.unAuditStateValue"  :min="0" :max="100"></el-input-number>
            </el-form-item>
        </el-col>
    </el-row> 
    <el-row>
        ...
        <el-col :span="12">
             <el-form-item label="是否有其他来源" prop="isStatic">
                 <el-switch
...
export default {
    ...
    return{
        ...
        textValues:[//0 常用材料库  消耗材料：1 进料登记选材 2 从总需用计划选材  3 进料登记（30进料登记PDA选材 31发料登记选材 32内部调拨登记选材 33外部调拨登记选材 ）4从磅单选材 5 合同选材 6从库存选材   
                {text:'0常用材料库',value:0,},  //周转材料：80：收料选材  81：调入选材  82：库存选材 83：报废选材
