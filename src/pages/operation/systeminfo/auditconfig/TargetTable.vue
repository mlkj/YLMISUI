                    ...
                    get () {
                        return {
                            ...
                            columns: [
                                ...
                                {attr: { prop: 'isOnly', label: '唯一', width:80,  scopedSlot:'isOnly'} },   
                                {attr: { prop: 'isCompute', label: '是否计算', width:120,  scopedSlot:'isCompute' } },   
                                {attr: { prop: 'computeType', label: '计算类型',width:100,  } }, 
                                {attr: { prop: 'textValue', label: 'textValue',width:160,  } },  
                                {attr: { prop: 'unAuditIsCompute', label: '撤销是否计算',width:120,  scopedSlot:'unAuditIsCompute' } },    
                                {attr: { prop: 'unAuditComputeType', label: '撤销计算类型',width:120,  } }, 
