...
<el-form  :model="formModel"  :rules="rules"  ref="formModel" label-width="100px" >
         ...
         <el-tabs v-model="activeName" style="height:350px">
            <el-tab-pane label="基本信息" name="first" >
                ...
                <el-row>
                    <el-col :span="12">
                         <el-form-item label="名称" prop="ghName">
                            <el-input v-model="formModel.ghName"  @blur="_setFullName"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
    ...
    methods:{
        ...
        _setFullName(){
            if(this.selectNode.fullName==undefined){
                this.formModel.ghFullName=this.getUserInfo().user.manageOrgName+'/'+this.formModel.ghName;
            }else{
                this.formModel.ghFullName=this.selectNode.fullName+'/'+this.formModel.ghName;
            }
        },
